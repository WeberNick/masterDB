...
class STimestamp {
  ...
  public:
    bool operator==(const STimestamp& x) const { return ((get_date() == x.get_date()) && (get_time() == x.get_time())); }
...
inline std::ostream& operator<<(std::ostream& os, const STimestamp& x) { return x.print(os, ':'); }
